...
# Create the clock
create_clock -name i_clk [get_ports intf_i_clk] -period $PERIOD

# Input delay
set_input_delay [expr 0.2 * $PERIOD] -clock [get_clocks intf_i_clk] {intf_i_start intf_i_comp}

# Output delay
set_output_delay [expr 0.2 * $PERIOD] -clock [get_clocks intf_i_clk] [all_outputs]
...
# Driving cell
set_driving_cell -no_design_rule -max -lib_cell TNBUFFX1_LVT {intf_i_start intf_i_comp}
